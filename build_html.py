...
#splash-quote {{
  font-size: 15px; line-height: 1.8; color: #d8e4f0;
...
.splash-today-title {{ font-size: 15px; color: #d8e4f0; }}
.splash-enter {{
...
.card-back-title {{ font-size: 13px; color: var(--text-dim); margin-bottom: 20px; border-bottom: 1px solid var(--border); padding-bottom: 16px; flex-shrink: 0; }}
...
.lesson-title-text {{ flex: 1; font-size: 14px; color: var(--text); }}
...
.quote-item-text {{ font-size: 13px; color: var(--text); line-height: 1.7; white-space: pre-line; margin-bottom: 6px; }}
...
.dedications-text {{
  font-size: 15px; color: #d8e4f0; font-style: normal;
...
.dedications-compiled {{
  font-size: 12px; color: #d8e4f0; font-style: normal;
}}
.dedications-body {{
  font-size: 14px; color: #d8e4f0; line-height: 1.7;
  margin-bottom: 2px;
}}
.dedications-spacer {{ height: 10px; }}
...
.st-framing {{
  font-size: 13px; color: var(--text-bright); line-height: 1.7;
...
.st-quote-text {{
  font-size: 14px; color: #d8e4f0; line-height: 1.65;
  margin-bottom: 6px;
}}
  ...
  <div class="panels">
    ...
    <div id="panel-dedications" class="panel dedications-panel">
      <div class="dedications-wrap">
        ...
        <div class="dedications-spacer"></div>
        <div class="dedications-body">This companion was born in one of my darkest places.<br>For me, it is my lantern.</div>
        <div class="dedications-spacer"></div>
    ...
    <div class="ref-section" id="ref-study-always-remember">
      ...
      <div class="ref-body">
        <div class="study-theme">
          ...
          <p class="st-framing">Am I a miracle worker?<br>What is Atonement?</p>
          ...
          <p class="st-framing">Not &lsquo;lose&rsquo; &mdash; but &lsquo;loose&rsquo;: to free from confinement, restraint, or obligation.</p>
