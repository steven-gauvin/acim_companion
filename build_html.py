...
<div id="splash">
  ...
  <div class="splash-quote-wrap">
    <div class="splash-quote-label">✦ My Favourite Daily Quote</div>
...
<div id="app">
  ...
  <div class="tab-bar">
    ...
    <div class="tab charts-tab-trigger" onclick="toggleChartsDropdown()" id="charts-tab-trigger">Charts &#9660;</div>
  </div>
  <div id="charts-dropdown" class="charts-dropdown" style="display:none">
    <div class="charts-dropdown-item" onclick="openChartsTab(0)">Map of the Mind</div>
    <div class="charts-dropdown-item" onclick="openChartsTab(1)">Key Teachings</div>
  </div>
...
function initSplash() {{
  ...
  document.getElementById('splash-lesson-num').textContent = 'Lesson ' + lesson.num;
  document.getElementById('splash-lesson-title').textContent = lesson.title;
...
function renderCard() {{
  ...
  const numLabel = isSpecial ? '✦ COMPLETION ✦' : 'LESSON ' + l.num;

  document.getElementById('cf-num').textContent = numLabel;
  document.getElementById('cf-title').textContent = l.title;
  document.getElementById('cf-num-card').textContent = numLabel;
  document.getElementById('cf-title-card').textContent = l.title;
  document.getElementById('cb-num').textContent = numLabel;
  document.getElementById('cb-title').textContent = l.title;
...
<div class="bigt-row"><div class="bigt-left">time</div><div class="bigt-center">&#x2726;</div><div class="bigt-right">Eternity</div></div>
  ...
  <div class="bigt-quote">
    ...
    <div class="ref-section" id="ref-study-header" style="background:transparent;border:none;margin-bottom:4px">
      <div style="padding:18px 4px 6px;font-size:11px;letter-spacing:2px;text-transform:uppercase;color:var(--gold);opacity:0.7">&#10022; Study Themes</div>
    </div>
